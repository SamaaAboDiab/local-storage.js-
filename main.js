...
// اغلاف عند الضغط علي x
closeModalBtn.addEventListener("click", () => {
  welcomeModal.classList.remove("active");
});

// اغلاق عند لما اضغط علي بد ا الاستكشاف
...
// ___________// local storage ___________//
